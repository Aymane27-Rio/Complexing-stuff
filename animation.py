...
class AnimatedFormula(Scene):
    def construct(self):
        ...
        formula_intro = Tex(r"We have the following formula that I have found online")
        ...
        text11 = Tex("For the other side of the formula, let's take a look at that \(\pi\). A really fascinating number. Take any circle you can think of, then take its circumference and divide it by its diameter. You'll always find the exquisite number \(\pi\).").scale(0.7)
        self.play(
